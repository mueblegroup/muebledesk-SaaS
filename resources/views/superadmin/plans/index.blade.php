<x-superadmin-layout>
    ...
    <x-slot name="header"><div><h1 class="text-2xl font-extrabold text-slate-950 dark:text-white">Subscription plans</h1><p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Fixed pricing, flexible duration, role limits, and server-enforced feature entitlements.</p></div></x-slot>
