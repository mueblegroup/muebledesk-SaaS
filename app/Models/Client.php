...
class Client extends Model
{
    ...
    protected $fillable = [
        'company_id', 'name', 'client_type', 'contact_person', 'email', 'billing_email', 'phone', 'website',
        'address', 'address_line_1', 'address_line_2', 'city', 'state', 'postcode', 'country_code',
        'tin_number', 'id_type', 'id_number', 'sst_registration_number', 'payment_terms_days', 'notes',
        'user_id', 'employee_id',
    ];
    ...
    public function customerUser() { return $this->belongsTo(User::class, 'user_id'); }
